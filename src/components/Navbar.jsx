...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-2 left-0 w-full z-50">
      <div className=" bg-white/30 rounded-full shadow-lg backdrop-blur-sm max-w-7xl mx-auto px-4 py-2 flex justify-between items-center">
        {/* Logo */}
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={toggleTheme}
            className="hidden md:block w-14 h-8 items-center px-1 bg-gray-200 dark:bg-gray-700 rounded-full relative transition-colors duration-300"
          >
            <span
